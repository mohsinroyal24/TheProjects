  ...
  return (
    <header className="text-gray-600 body-font sticky top-0 z-10 bg-white shadow">
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center w-full">
          ...
          <div className="relative flex-grow w-1/5">
            <input
              type="text"
              value={query}
            ...
            {dropdown.length > 0 && (
              <div className="absolute left-0 right-0 mt-1 bg-white border rounded-b shadow-md">
                {dropdown.map((item) => (
                  <div
                    key={item.slug}
                  ...
                  >
                    ...
                    <div>
                      <button
                        ...
                        className="subtract cursor-pointer inline-block px-3 py-1 mr-2 bg-purple-500 text-white font-semibold rounded-lg shadow-md"
                      >
                        -
                      </button>
                      ...
                      <button
                        ...
                        className="add cursor-pointer inline-block px-3 py-1 ml-2 bg-purple-500 text-white font-semibold rounded-lg shadow-md"
                      >
                        +
                      </button>
                    </div>
          ...
          <select className="w-1/5 md:w-24 mt-2 px-4 py-2 rounded border">
